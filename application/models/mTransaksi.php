...
class mTransaksi extends CI_Model
{
	...
	public function detail_pesanan($id)
	{
		...
		$data['transaksi'] = $this->db->query("SELECT * FROM `pemesanan` JOIN pelanggan ON pelanggan.id_pelanggan=pemesanan.id_pelanggan JOIN pengiriman ON pengiriman.id_pengiriman=pemesanan.id_pengiriman WHERE id_pemesanan='" . $id . "'")->row();
