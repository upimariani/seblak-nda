...
class cOngkir extends CI_Controller
{
	...
	// 	$this->session->set_flashdata('success', 'Data Ongkos Kirim Berhasil Ditambahkan!');
	...
	// 	$this->session->set_flashdata('success', 'Data Ongkos Kirim Berhasil Diperbaharui!');
	// 	redirect('Admin/cOngkir');
	// }
	// public function delete($id)
	// {
	// 	$this->mOngkir->delete($id);
	// 	$this->session->set_flashdata('success', 'Data Ongkos Kirim Berhasil Dihapus!');
	// 	redirect('Admin/cOngkir');
	// }
}
